...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'ngx-wellness-evoucher';
    }
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(userService) {
        ...
        this.message = "Sign in with your NRIC and Date of Birth";
        this.success = false;
    ...
    LoginComponent.prototype.login = function () {
        ...
        if (this.birthDay && this.companyCode && this.nric) {
            var username = this.companyCode + "@at@" + this.nric;
            var password = this.birthDay.toString();
            console.log(username, password);
            this.userService.checkLogin(username, password).subscribe(function (res) {
                console.log(res);
            });
        }
        if (this.nric) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.checkLogin = function (username, password) {
        return this.http.post("" + src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiEndPoint + this.loginUrl, {
            _username: username,
            _password: password
        }, {
...
module.exports = __webpack_require__(/*! /home/bamboo/sunrise/ngx-wellness-evoucher/src/main.ts */"./src/main.ts");
